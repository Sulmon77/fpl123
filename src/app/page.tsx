          ...
          <div className="relative w-full max-w-6xl mx-auto px-4 sm:px-6 pt-16 pb-28 sm:pt-20 sm:pb-36">
            <div className="flex flex-col items-center text-center max-w-3xl mx-auto">
              ...
              <p className="text-white/50 text-[1.05rem] sm:text-lg mb-10 max-w-md leading-relaxed animate-slide-up delay-75">
                A small private circle of serious FPL managers. Top scorers each week get paid — straight to M-Pesa or PayPal.
              </p>
          ...
          <div className="max-w-5xl mx-auto px-4 sm:px-6">
            ...
            <div className="grid sm:grid-cols-3 gap-5">
              ...
              <div className="relative card p-7 hover:shadow-card-hover transition-shadow duration-200">
                ...
                <h3 className="font-bold text-text-primary text-[1.05rem] mb-2">Top your small group, get paid</h3>
                <p className="text-text-secondary text-sm leading-relaxed">Highest scorers in your small group receive their share directly — M-Pesa or PayPal by Tuesday.</p>
              </div>
